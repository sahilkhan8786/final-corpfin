...
const PricingPlans = ({ isShwoing = true, isLink = false, }) => {
    return (
        <>

            {isShwoing && <div className="w-full h-[70vh] ">
            ...
            <div className='w-full max-w-[1440px] mx-auto  my-24 flex gap-4 items-center justify-center flex-col md:flex-row flex-wrap'>
                <article className='border w-[312px] px-4 py-6 rounded-xl '>
                    ...
                    {isLink && <Link to={`/dashboard/subscription-selected`}>
                        <button className='flex w-full py-3 bg-[#8DF5E780] text-primary font-semibold text-[16px] items-center justify-center'>
                            Choose Plan &rarr;
                        </button>
                    </Link>}
                    {!isLink && <button className='flex w-full py-3 bg-[#8DF5E780] text-primary font-semibold text-[16px] items-center justify-center'>
                        Choose Plan &rarr;
                    </button>}
                </article>
                <article className='border border-primary w-[312px] px-4 py-6 rounded-xl relative mt-8'>
                    ...
                    {!isLink && <button className='flex w-full py-3 bg-primary text-white font-semibold text-[16px] items-center justify-center'>
                        Choose Plan &rarr;
                    </button>}
