        ...
        <>
            ...
            <div className='flex flex-col gap-6 max-w-[1400px] mx-auto my-6 px-6 sm:px-8'>
                ...
                <article className='flex items-center justify-between gap-6 mt-16 flex-col md:flex-row'>
                    ...
                    <div>
                        <h1 className='  text-center  text-[#0D0D0D] font-medium text-[28px] '>Extensive Coverage</h1>
                        <p className=' text-[16px] text-center text-[#3B3B3B]'>Diverse coverage options for <br /> your unique needs</p>
                    </div>
                    <div>
                        <h1 className='text-center text-[#0D0D0D] font-medium text-[28px] '>Responsive Service</h1>
                        <p className=' text-[16px] text-[#3B3B3B]'>We aid in coverage selection and  <br />swiftly handle inquiries and claims</p>
                    </div>
                    <div>
                        <h1 className='  text-center  text-[#0D0D0D] font-medium text-[28px] '>Competitive Rates</h1>
                        <p className='  text-center   text-[16px] text-[#3B3B3B]'>Competitive rates, making insurance  <br />accessible to all</p>
                    </div>
                </article>
            </div>
                ...
                <article className='flex gap-6 justify-between flex-col md:flex-row'>
                    <div className='flex flex-col gap-8 border p-8'>
                        ...
                        <p className='flex items-center gap-2'>
                            ...
                            <span className='text-[#3B3B3B] text-[18px]'>Personal insurance provides a financial safety net <br /> for unexpected situations</span>
                        </p>
                        <p className='flex items-center gap-2'>
                            <img src="/Check.png" alt="" />
                            <span className='text-[#3B3B3B] text-[18px]'>Insurance covers medical expenses, disability, and <br /> critical illnesses, safeguarding your well-being.</span>
                        </p>
                        <img src="/bwink_med_02_single_04.png" alt="" className='w-full md:w-1/2 ' />
                    </div>
            ...
            <div className='bg-[#F8F8F8] py-16 px-6 sm:px-8'>
                ...
                <form className='flex w-full max-w-[1440px] mx-auto my-16  gap-12 flex-col md:flex-row'>
                    <article className=' w-full flex flex-col gap-3'>
                        ...
                        <p className=' font-medium text-[24px] text-[#0D0D0D]'>+123 456 56 67</p>
                        <p className=' text-[#6A6A6A] text-[12px]'>Write to us</p>
...
export default StartupLandingPageEarlyStage