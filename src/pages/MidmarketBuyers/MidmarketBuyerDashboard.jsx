...
import MidMarketBuyerNDA from '../../components/MidMarketBuyerNDA'
import { AnimatePresence, motion } from 'framer-motion';
const MidmarketBuyerDashboard = () => {
    ...
    return (
        <>
            <div className='w-full fixed bottom-0 left-0 flex z-40  xl:hidden'>
                <button className='text-white bg-primary flex-1 py-3' onClick={() => setIsFilterShown(true)}>Filter</button>
                <button className='text-[#474C54] bg-[#F5F5F5] flex-1 py-3'>Sort By</button>
            </div>

            <section >
                <MidmarketSellerHeader />
                <div className='max-w-[1440px] mx-auto'>
                    <div className='pt-4 mt-6 relative w-full'>
                        <button className='hidden md:block absolute top-1/2 -translate-y-1/2 mx-6 text-white bg-primary px-4 py-3'>Susbcribe</button>
                        <img src="/bANNER1 1.png" alt="" className='w-full h-full' />

                    </div>
                </div>


                <div className='w-full flex justify-between gap-3 my-6 max-w-[1440px] mx-auto flex-col md:flex-row'>
                    <article className=' w-full  flex items-center gap-2 px-3 py-2 border mx-2'>
                    ...
                    <div className='flex w-full'>
                        ...
                        <button className=' text-white bg-primary px-4 py-3 mx-2'>Search</button>
                    </div>
                    <article className=' w-full   items-center gap-2 px-3 py-2 border hidden xl:flex'>
                        <img src="/fi_layers.png" alt="" />
                        <select type="text" className='w-full outline-none focus:outline-none  bg-transparent' >
                ...
                <div className='max-w-[1440px] mx-auto px-4 w-full flex gap-4'>
                    {/* FOR DESKTOP */}
                    <div className='flex-1 w-full hidden xl:block'>
                    ...
                    {/* FOR MOBILE */}
                    {isFilterShown && <div className='flex-1 w-full xl:hidden fixed top-0 left-0 bg-white z-50 h-screen p-4'>
                        <h1 className='text-primary font-semibold text-[16px]'>Filter</h1>
                        ...
                        <article className=' w-full  flex items-center gap-2 py-2 '>
                            ...
                            <button className='px-3 py-2 text-primary border-2 border-primary font-medium whitespace-nowrap' onClick={() => setIsFilterShown(false)}>Clear All</button>
                            <button className='px-3 py-2 text-white bg-primary border-2 border-primary font-medium whitespace-nowrap' onClick={() => setIsFilterShown(false)}>Apply</button>
                        </article>
                    </div>}
                        ...
                        <div className='flex flex-col gap-3 w-full ' >
                            ...
                            <article className='flex w-full flex-col gap-4 my-2 border  p-3 shadow-lg'>
                                ...
                                <div className='flex justify-between w-full'>
                                    ...
                                    <article className='flex justify-between gap-2 flex-row md:gap-0 relative w-full'>
                                        <div className='absolute -right-3 -top-3 block xl:hidden'>
                                            <img src="/Rectangle 510.png" alt="" />
                                        </div>
                                        <div className='absolute -right-3 -top-4 block xl:hidden'>
                                ...
                                <div className='flex justify-between w-full gap-4 flex-col md:flex-row relative md:static overflow-hidden pb-12 md:pb-0'>
                                                    ...
                                                    <article className='flex flex-col justify-center gap-4 items-center relative '>
                                                        ...
                                                        <div className='flex items-center justify-center w-full'>
                                                            ...
                                                            <button
                                                                ...
                                                                className='bg-primary text-white p-4 hover:opacity-80 w-fit md:w-full'>Sign NDA &
                                    ...
                                    <article className='flex flex-row justify-between relative overflow-hidden md:flex-col cursor-pointer'>
                                        <div className='absolute right-0 -bottom-16 bg-[#8DF5E780] w-[50px] h-[96px] rounded-full justify-center hidden md:flex' onClick={toggleExpand}>
                                    ...
                                    <article className='flex flex-col justify-center gap-4 items-center relative '>
                                        ...
                                        <div className='absolute right-2 -top-1 hidden xl:block'>
                                            <span className='text-white text-[10px]'>New Lisiting</span>
                                        </div>
                                    ...
                                    <div className='absolute right-1/2 translate-x-1/2 -bottom-16 bg-[#8DF5E780] w-[50px] h-[96px] rounded-full flex justify-center md:hidden cursor-pointer' onClick={toggleExpand}>
                                        <img src="/Arrow down sign to navigate.png" alt="" className='w-fit  h-fit py-2 ' />
                                    </div>
                                </div>
                                <AnimatePresence>
                ...
                {isClicked && <MidMarketBuyerNDA setIsClicked={setIsClicked} />}
...
export default MidmarketBuyerDashboard