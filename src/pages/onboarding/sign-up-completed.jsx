    ...
    return (
        <section className='flex items-center justify-center w-full md:w-[556px] h-screen flex-col gap-7 md:mx-auto px-4'>
            ...
            <div className='flex items-center justify-center w-full  md:w-[410px] md:gap-4   '>
                ...
                <Link to={'/midmarket-seller-listing-detail-page'} className='w-full'>
                    <button className='text-white px-5 py-3 hover:opacity-85 bg-primary  mx-4 whitespace-nowrap'>List Business &nbsp;&nbsp; &rarr;</button>
                </Link>
