...
const MidMarketBuyerNDA = ({ setIsClicked }) => {
    return (
        <section className='fixed top-0 left-0 w-full h-screen bg-white flex items-center justify-center'>
            <div className='max-w-[800px] mx-auto px-6 md:px-12 flex flex-col gap-6'>
                <h1 className='text-primary  font-semibold text-[16px]'>Non DisclosureAgreement</h1>

                <p className='text-[#132F41] font-semibold text-[13px]'>Between Parties</p>

                <div className='w-full h-[300px] overflow-y-scroll whitespace-pre'>
                    <pre className='text-[#6B6B6B] text-[12px] whitespace-pre-line'>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <label htmlFor="check" className='text-[12px]'>Sign NDA & Request access to VDR or View NDA [if deal accessed]</label>
                </div>
                <div className='flex w-full items-center justify-center gap-4'>
                    <button
                        onClick={() => setIsClicked(false)}
                        className='border-2 border-primary font-medium hover:opacity-85 px-3 py-3 text-primary'>Cancel</button>
                    <button className='border-2 border-primary font-medium hover:opacity-85 px-3 py-3 bg-primary text-white'>Request For Access</button>
                </div>
            </div>
        </section>
    )
...
export default MidMarketBuyerNDA